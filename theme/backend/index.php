		...
		<div class="leftside-menu">
			...
			<div class="h-100" id="leftside-menu-container" data-simplebar>
				...
				<ul class="side-nav">
					...
					<li class="side-nav-item">
						<a href="<?= base_url("admin/scraper") ?>" class="side-nav-link">
							<i class="uil-sync"></i>
							<span> Auto Update Scraper </span>
							<?php 
							$scraper_settings = $this->db->get_where('scraper_settings', ['id' => 1])->row();
							if ($scraper_settings && $scraper_settings->auto_update_enabled): 
							?>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							...
							</script> © AdminPanel by <a href="https://codeidn.com">codeidn.com</a>
						</div>
					</div>
				</div>
			</footer>
